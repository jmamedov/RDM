...
namespace RDM.Blazor.Services
{
    ...
    public interface INodeBillOfMaterialService
    {
        ...
        Task DeleteAsync(int hierarchyTypeId, long parentNodeId, long childNodeId);
    }
    ...
    public class NodeBillOfMaterialService : INodeBillOfMaterialService
    {
        ...
        public async Task DeleteAsync(int hierarchyTypeId, long parentNodeId, long childNodeId)
        {
